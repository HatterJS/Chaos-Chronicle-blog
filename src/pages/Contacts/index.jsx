    ...
    <div className="contacts">
      ...
      <div className="contacts__content">
        ...
        <div className="contacts__telegram unselectable">
          <a
            href="https://t.me/ChaosChroniclesBlog"
            target={"_blank"}
            rel="noreferrer"
          >
            <img
              src="/img/logo/channel_QR.jpg"
              alt="telegram"
              width={150}
              height={150}
            />
        ...
        <br />
        <p>
          Якщо виникли питання або потрібна додаткова інформація, будь ласка,
          звертайтесь:
        </p>
        <div className="contacts__telegram unselectable">
          <a
        ...
        <br />
        <p>
          Дякуємо за використання нашого сервісу і сподіваємося на продуктивну
          співпрацю з Вами!
        </p>
      </div>
    </div>
