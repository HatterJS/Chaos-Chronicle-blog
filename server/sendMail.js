...
export const sendMail = (req, token) => {
  const mailOptions = {
    ...
    html: `<p>Шановний(а) ${req.body.fullName}!</p><p>Вітаємо на <b>Chaos Chronicle!</b> Ваш обліковий запис було створено успішно. Щоб підтвердити свою реєстрацію та активувати обліковий запис, будь ласка, натисніть <a href="http://localhost:3000/confirmemail/${token}">ПІДТВЕРДИТИ.</a></p><p></p><p>Якщо ви не реєструвались на нашому сайті, ігноруйте цей лист. Можливо, хтось випадково ввів вашу електронну адресу.</p><p></p><p>Якщо у вас виникли будь-які питання або проблеми з вашим обліковим записом, опишіть обставини у зворотньому листі.</p><p></p><p>Дякуємо,<br>Команда ccblog.com.ua</p>`
  };
